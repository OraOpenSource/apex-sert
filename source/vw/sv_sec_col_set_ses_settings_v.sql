CREATE OR REPLACE VIEW sv_sec_col_set_ses_settings_v
AS
SELECT
  seq_id             id,
...
WHERE
  ...
  AND a.category_id = (SELECT category_id FROM sv_sec_categories WHERE category_key = 'SV_SET_SESSION_DURATION')
