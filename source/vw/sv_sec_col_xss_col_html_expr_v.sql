CREATE OR REPLACE VIEW sv_sec_col_xss_col_html_expr_v
AS
SELECT
  seq_id             id,
  ...
  sv_sec_util.get_column(e.column_id, e.attribute_id) col,
...
FROM
  ...
  sv_sec_exceptions e
WHERE
  collection_name = 'SV_XSS_COL_HTML_EXPR'
