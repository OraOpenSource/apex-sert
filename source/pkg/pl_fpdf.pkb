...
*******************************************************************************/
----------------------------------------------------------------------------------
-- proc. and func. sp�cifiques ajout�es au portage.
----------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------
-- Inclusion des m�triques d'une font.
----------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------
-- p_getFontMetrics : r�cup�rer les metric d'une font.
----------------------------------------------------------------------------------
...
begin
    -- Procedure inutile avec le PLSQL : toutes les fonts sont charg�es en m�moire.
	return null;
end p_getfontpath;
...
procedure AddFont (family varchar2, style varchar2 default '',filename varchar2 default '') is
  ...
  myType varchar2(256); -- ????????? Cette variable est peut-�tre globale ????????????
  -- tabNull tv4000;
begin
